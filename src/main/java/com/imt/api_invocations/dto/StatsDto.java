...
/**
 * DTO for game entity stats (HP, ATK, DEF, VIT). Uses long instead of double for precise integer
 * values. Numeric constraints are validated against NumericConstraintsConfig.
 */
@Getter
@SuperBuilder
@NoArgsConstructor
...
public class StatsDto {
  ...
  @Schema(
      description = "Points de vie (Health Points)",
      example = "1500",
      minimum = "1",
  ...
  @Schema(
      description = "Points d'attaque (Attack)",
      example = "250",
      minimum = "1",
      requiredMode = Schema.RequiredMode.REQUIRED)
  private long atk;
  ...
  @Schema(
      description = "Points de défense (Defense)",
      example = "180",
      minimum = "1",
      requiredMode = Schema.RequiredMode.REQUIRED)
  private long def;
  ...
  @Schema(
      description = "Points de vitalité (Vitality)",
      example = "120",
      minimum = "1",
      requiredMode = Schema.RequiredMode.REQUIRED)
  private long vit;
