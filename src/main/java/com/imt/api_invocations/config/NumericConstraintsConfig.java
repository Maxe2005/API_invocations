...
/**
 * Centralized configuration for numeric constraints on game entities. All numeric limits (min/max)
 * are defined here and externalized in properties. This ensures consistency across the application
