 ...
 * 
 * Can be configured with custom min/max values, or use predefined constraint
 * types
 * that pull configuration from NumericConstraintsConfig.
 * 
 * Usage examples:
 * {@code @IntRange(constraintType = ConstraintType.STAT) private long hp;}
