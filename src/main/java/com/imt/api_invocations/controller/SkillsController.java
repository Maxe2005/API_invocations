...
public class SkillsController {
  ...
  @Operation(
      ...
      description =
          "Crée une nouvelle compétence avec ses caractéristiques (dégâts, cooldown, niveau max, rang). "
  ...
  @Operation(
      ...
      description =
          "Récupère les détails complets d'une compétence incluant ses statistiques et son rang.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Compétences trouvées",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = SkillsWithIdDto.class))),
        @ApiResponse(
            responseCode = "404",
            description = "Aucune compétence trouvée pour ce monstre",
            content = @Content),
        @ApiResponse(responseCode = "401", description = "Non authentifié", content = @Content)
      })
  ...
  @Operation(
      ...
      description =
          "Modifie les informations d'une compétence existante. Seuls les champs fournis seront mis à jour.")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<Void> updateSkill(
      ...
      @Parameter(description = "Données de mise à jour de la compétence", required = true)
          @Valid
          @RequestBody
          SkillsHttpUpdateDto skillsUpdateDto) {
  ...
  @Operation(
      ...
      description =
          "Supprime définitivement une compétence de la base de données. Cette action est irréversible.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<Map<String, Boolean>> deleteSkillById(
      @Parameter(
              description = "Identifiant unique de la compétence à supprimer",
              required = true,
              example = "507f1f77bcf86cd799439011")
          @PathVariable
          String skillId) {
  ...
  @Operation(
      ...
      description =
          "Supprime toutes les compétences associées à un monstre spécifique. Retourne le nombre de compétences supprimées.")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Compétences supprimées avec succès",
            content =
                @Content(
                    mediaType = "application/json",
