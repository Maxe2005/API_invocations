...
public class MonsterController {
    ...
    public ResponseEntity<String> createMonster(
            @Parameter(description = "Données du monstre à créer",
    ...
    public ResponseEntity<GlobalMonsterWithIdDto> getMonsterById(
        ...
        return ResponseEntity
                .ok(dtoMapper.toGlobalMonsterWithIdDto(monsterMongoDto, includeSkills));
    }
    ...
    public ResponseEntity<Map<String, Boolean>> deleteMonster(
            @Parameter(description = "Identifiant unique du monstre à supprimer", required = true,
