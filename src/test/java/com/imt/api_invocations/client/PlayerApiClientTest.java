...
class PlayerApiClientTest {
  ...
  @InjectMocks private PlayerApiClient playerApiClient;
  ...
  class AddMonsterToPlayerTests {
    ...
    void should_AddMonsterToPlayerSuccessfully_When_ApiReturns200() {
      ...
      when(restTemplate.postForEntity(
              anyString(), any(PlayerAddMonsterRequest.class), eq(PlayerResponse.class)))
      ...
      verify(restTemplate, times(1))
          .postForEntity(
              ...
              any(PlayerAddMonsterRequest.class),
    ...
    void should_SendCorrectRequest_When_AddMonsterToPlayerCalled() {
      ...
      verify(restTemplate)
          .postForEntity(anyString(), requestCaptor.capture(), eq(PlayerResponse.class));
    ...
    void should_ThrowExternalApiException_When_PlayerNotFound() {
      ...
      when(restTemplate.postForEntity(
              anyString(), any(PlayerAddMonsterRequest.class), eq(PlayerResponse.class)))
          .thenThrow(new HttpClientErrorException(HttpStatus.NOT_FOUND, "Player not found"));
      ...
      verify(restTemplate, times(1))
          .postForEntity(anyString(), any(PlayerAddMonsterRequest.class), eq(PlayerResponse.class));
    }
    ...
    void should_ThrowExternalApiException_When_BadRequest() {
      ...
      when(restTemplate.postForEntity(
              anyString(), any(PlayerAddMonsterRequest.class), eq(PlayerResponse.class)))
          .thenThrow(new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Invalid monster ID"));
    ...
    void should_ThrowExternalApiException_When_ResponseBodyIsNull() {
      ...
      String username = "player123";
      String monsterId = "monster-456";
      ResponseEntity<PlayerResponse> responseEntity = new ResponseEntity<>(null, HttpStatus.OK);
