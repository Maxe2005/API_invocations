...
class StatsServiceTest {
  ...
  void should_FormatTheoreticalLootRates_When_Called() {
    ...
    assertThat(result)
        .contains("Theoretical Drop Rates:")
        .contains("COMMON: 50.00%")
        .contains("RARE: 30.00%")
        .contains("EPIC: 15.00%")
        .contains("LEGENDARY: 5.00%");
  }
  ...
  void should_ComputeRealLootRates_When_SomeRanksUnavailable() {
    ...
    assertThat(result)
        .contains("Real Drop Rates")
        .contains("COMMON: 76.92%")
        .contains("EPIC: 23.08%")
        .contains("RARE: 0.00%")
        .contains("LEGENDARY: 0.00%");
  }
